...
const HELP = {
  ...
  backup: {
    ...
    b: "Der Plan liegt im Speicher des Browsers. Der überlebt keinen geleerten Cache, keinen Gerätewechsel und keinen privaten Tab.<br><br>Der Export schreibt alles in eine JSON-Datei: Handeingaben, sämtliche Belege, erfasste Kontostände, geänderte EZB-Reihenschlüssel. Der Import liest sie zurück und lädt die Seite neu.<br><br>Nach zwei Jahren gesammelter Angebote ist das die einzige Zahl in diesem Werkzeug, die sich nicht wiederbeschaffen lässt.",
  },
